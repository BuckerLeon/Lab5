...
public class PokerTableController {
	...
	@FXML
	public HBox WinnerTop;
	@FXML
	public HBox WinnerBottom;
	@FXML
	public HBox WinnerLeft;
	@FXML
	public HBox WinnerRight;
	...
	private void handlePlay() {
		...
		Rule rle = RootLayoutController.Rle;
	...
	public void DealWinnerImage(int iPlayerPosition) {
		...
		case 1:
			PlayerCardBox = WinnerBottom;
			break;

		case 2:
			PlayerCardBox = WinnerLeft;
			break;

		case 3:
			PlayerCardBox = WinnerTop;
			break;

		case 4:
			PlayerCardBox = WinnerRight;
			break;

		}
		String strCard = "/res/img/win.jpg";
	...
	public void ClearWinnerImage() {

		WinnerBottom.getChildren().clear();
		WinnerLeft.getChildren().clear();
		WinnerTop.getChildren().clear();
		WinnerRight.getChildren().clear();
	...
	private void handleDraw() {
		...
		if (act.isbEvaluateHand()) {
			...
			DealWinnerImage(WinningPlayer.getiPlayerPosition());
			// TODO
